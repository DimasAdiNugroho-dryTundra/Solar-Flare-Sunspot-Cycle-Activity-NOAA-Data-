...
| **10.7 cm Solar Radio Flux** | **`202.8 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`1.47`** | `[▰▰▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`M6.0 @ 15:26 UTC`** | `C:8  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
