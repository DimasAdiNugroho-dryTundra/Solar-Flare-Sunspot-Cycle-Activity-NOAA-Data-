...
| **10.7 cm Solar Radio Flux** | **`200.9 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`0.94`** | `[▰▱▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`C2.5 @ 14:10 UTC`** | `C:7  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
