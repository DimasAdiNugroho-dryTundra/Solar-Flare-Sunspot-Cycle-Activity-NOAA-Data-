...
| **10.7 cm Solar Radio Flux** | **`178.6 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`4.17`** | `[▰▰▰▰▰▱▱▱▱▱]` | **G0 (Active)** — Auroral oval expands to high latitudes |
| **24h Solar Flare Activity** | **`C1.5 @ 05:20 UTC`** | `C:8  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-09-12` | **209** | 221.4 sfu | Kp 1.75 | 🟢 Quiet | `C:11 M:1 X:0` | `M2.4` |
| `2025-09-13` | **202** | 216.1 sfu | Kp 1.25 | 🟢 Quiet | `C:7 M:0 X:0` | `C8.6` |
