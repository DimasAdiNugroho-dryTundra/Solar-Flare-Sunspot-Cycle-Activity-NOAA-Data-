...
| **10.7 cm Solar Radio Flux** | **`204.3 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`3.84`** | `[▰▰▰▰▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C1.3 @ 20:25 UTC`** | `C:6  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2026-01-17` | **200** | 215.7 sfu | Kp 3.99 | 🟢 Nominal | `C:6 M:0 X:0` | `C8.2` |
| `2026-01-18` | **182** | 196.7 sfu | Kp 1.43 | 🟢 Quiet | `C:10 M:0 X:0` | `C2.2` |
| `2026-01-19` | **181** | 197.3 sfu | Kp 4.14 | 🟡 Active | `C:6 M:0 X:0` | `C1.4` |
| `2026-01-20` | **180** | 195.0 sfu | Kp 3.33 | 🟢 Nominal | `C:8 M:0 X:0` | `C2.3` |
| `2026-01-21` | **176** | 203.4 sfu | Kp 2.17 | 🟢 Nominal | `C:8 M:0 X:0` | `C8.7` |
| `2026-01-22` | **195** | 204.7 sfu | Kp 5.87 | 🟠 G1 Minor | `C:6 M:0 X:0` | `C3.1` |
| `2026-01-23` | **178** | 204.3 sfu | Kp 3.84 | 🟢 Nominal | `C:6 M:0 X:0` | `C1.3` |
