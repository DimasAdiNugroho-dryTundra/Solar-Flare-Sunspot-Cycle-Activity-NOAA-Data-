...
| **10.7 cm Solar Radio Flux** | **`174.5 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.64`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C8.0 @ 13:32 UTC`** | `C:10  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-06-02` | **157** | 172.3 sfu | Kp 0.83 | 🟢 Quiet | `C:7 M:2 X:0` | `M2.9` |
| `2025-06-03` | **146** | 159.4 sfu | Kp 3.68 | 🟢 Nominal | `C:7 M:0 X:0` | `C8.7` |
