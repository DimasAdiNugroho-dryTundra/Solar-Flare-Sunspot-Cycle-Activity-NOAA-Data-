...
| **Planetary Kp-Index (3h Max)** | **`5.84`** | `[▰▰▰▰▰▰▱▱▱▱]` | **G1 (Minor Storm)** — Weak power grid fluctuations; aurora at ~60° |
| **24h Solar Flare Activity** | **`C4.4 @ 15:02 UTC`** | `C:9  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
