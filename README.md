...
| **10.7 cm Solar Radio Flux** | **`186.7 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.78`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C2.3 @ 06:51 UTC`** | `C:5  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| `2026-02-16` | **151** | 177.2 sfu | Kp 2.88 | 🟢 Nominal | `C:6 M:0 X:0` | `C8.4` |
| `2026-02-17` | **160** | 189.2 sfu | Kp 0.86 | 🟢 Quiet | `C:6 M:1 X:0` | `M1.8` |
| `2026-02-18` | **172** | 189.0 sfu | Kp 6.06 | 🔴 G2 Moderate | `C:8 M:0 X:0` | `C5.4` |
