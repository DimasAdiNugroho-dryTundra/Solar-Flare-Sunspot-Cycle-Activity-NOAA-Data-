...
| **10.7 cm Solar Radio Flux** | **`205.5 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.76`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`M2.6 @ 22:41 UTC`** | `C:10  M:2  X:0` | **🟡 MODERATE / ELEVATED** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-07-06` | **168** | 190.6 sfu | Kp 7.65 | 🔴 G3 Strong | `C:10 M:0 X:0` | `C8.8` |
| `2025-07-07` | **173** | 187.9 sfu | Kp 0.77 | 🟢 Quiet | `C:8 M:0 X:0` | `C5.7` |
| `2025-07-08` | **158** | 176.6 sfu | Kp 0.82 | 🟢 Quiet | `C:7 M:0 X:0` | `C8.2` |
| `2025-07-09` | **185** | 197.0 sfu | Kp 0.77 | 🟢 Quiet | `C:10 M:0 X:0` | `C9.4` |
| `2025-07-10` | **163** | 191.2 sfu | Kp 4.40 | 🟡 Active | `C:6 M:1 X:0` | `M4.5` |
| `2025-07-11` | **182** | 196.5 sfu | Kp 2.11 | 🟢 Nominal | `C:9 M:0 X:0` | `C6.1` |
| `2025-07-12` | **178** | 205.5 sfu | Kp 2.76 | 🟢 Nominal | `C:10 M:2 X:0` | `M2.6` |
