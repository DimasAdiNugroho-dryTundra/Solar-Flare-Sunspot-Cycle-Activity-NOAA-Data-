...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`138`** | `[▰▰▰▰▰▰▱▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`151.9 sfu`** | `[▰▰▰▰▰▱▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`6.03`** | `[▰▰▰▰▰▰▰▱▱▱]` | **G2 (Moderate Storm)** — High-latitude power alarms; satellite drag |
| **24h Solar Flare Activity** | **`C5.4 @ 17:32 UTC`** | `C:7  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2026-05-18` | **160** | 179.1 sfu | Kp 4.56 | 🟡 Active | `C:8 M:0 X:0` | `C7.7` |
| `2026-05-19` | **153** | 170.5 sfu | Kp 2.56 | 🟢 Nominal | `C:9 M:0 X:0` | `C2.5` |
| `2026-05-20` | **138** | 166.2 sfu | Kp 2.12 | 🟢 Nominal | `C:9 M:0 X:0` | `C2.0` |
| `2026-05-21` | **144** | 158.7 sfu | Kp 3.70 | 🟢 Nominal | `C:5 M:1 X:0` | `M8.8` |
| `2026-05-22` | **119** | 135.3 sfu | Kp 0.97 | 🟢 Quiet | `C:4 M:0 X:0` | `C5.2` |
| `2026-05-23` | **120** | 144.4 sfu | Kp 2.93 | 🟢 Nominal | `C:8 M:0 X:0` | `C8.7` |
| `2026-05-24` | **138** | 151.9 sfu | Kp 6.03 | 🔴 G2 Moderate | `C:7 M:0 X:0` | `C5.4` |
