...
| **10.7 cm Solar Radio Flux** | **`181.3 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.64`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C2.1 @ 11:03 UTC`** | `C:8  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-10-23` | **144** | 168.6 sfu | Kp 1.15 | 🟢 Quiet | `C:6 M:0 X:0` | `C9.4` |
