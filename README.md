...
| **10.7 cm Solar Radio Flux** | **`217.5 sfu`** | `[▰▰▰▰▰▰▰▰▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.45`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C3.6 @ 10:55 UTC`** | `C:8  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-08-29` | **196** | 210.4 sfu | Kp 3.95 | 🟢 Nominal | `C:10 M:0 X:0` | `C5.4` |
| `2025-08-30` | **182** | 200.9 sfu | Kp 0.94 | 🟢 Quiet | `C:7 M:0 X:0` | `C2.5` |
