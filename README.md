...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`128`** | `[▰▰▰▰▰▱▱▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`152.1 sfu`** | `[▰▰▰▰▰▱▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.45`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C6.3 @ 18:09 UTC`** | `C:9  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| `2025-11-08` | **143** | 166.2 sfu | Kp 0.74 | 🟢 Quiet | `C:8 M:0 X:0` | `C2.6` |
| `2025-11-09` | **147** | 172.9 sfu | Kp 1.54 | 🟢 Quiet | `C:5 M:0 X:0` | `C9.4` |
