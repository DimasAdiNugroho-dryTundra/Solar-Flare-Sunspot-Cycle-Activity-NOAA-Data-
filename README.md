...
| **10.7 cm Solar Radio Flux** | **`164.5 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.27`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C9.6 @ 11:25 UTC`** | `C:6  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| `2025-08-22` | **152** | 164.5 sfu | Kp 2.27 | 🟢 Nominal | `C:6 M:0 X:0` | `C9.6` |
