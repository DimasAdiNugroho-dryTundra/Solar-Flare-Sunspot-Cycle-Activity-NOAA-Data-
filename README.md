...
| **10.7 cm Solar Radio Flux** | **`181.1 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`5.02`** | `[▰▰▰▰▰▰▱▱▱▱]` | **G1 (Minor Storm)** — Weak power grid fluctuations; aurora at ~60° |
| **24h Solar Flare Activity** | **`C3.6 @ 14:29 UTC`** | `C:6  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
