...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`127`** | `[▰▰▰▰▰▱▱▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`160.3 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.41`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C7.8 @ 12:01 UTC`** | `C:7  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| `2026-08-09` | **127** | 160.3 sfu | Kp 2.41 | 🟢 Nominal | `C:7 M:0 X:0` | `C7.8` |
