...
| **10.7 cm Solar Radio Flux** | **`194.7 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`7.33`** | `[▰▰▰▰▰▰▰▰▱▱]` | **G3 (Strong Storm)** — Voltage corrections needed; satellite orientation |
| **24h Solar Flare Activity** | **`M1.8 @ 00:53 UTC`** | `C:6  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
