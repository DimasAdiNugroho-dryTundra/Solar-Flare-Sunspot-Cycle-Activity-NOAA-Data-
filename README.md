...
| **Planetary Kp-Index (3h Max)** | **`6.06`** | `[▰▰▰▰▰▰▰▱▱▱]` | **G2 (Moderate Storm)** — High-latitude power alarms; satellite drag |
| **24h Solar Flare Activity** | **`C5.4 @ 02:45 UTC`** | `C:8  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
