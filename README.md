...
| **10.7 cm Solar Radio Flux** | **`160.4 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.59`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C8.6 @ 14:15 UTC`** | `C:7  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2026-06-09` | **159** | 183.2 sfu | Kp 2.44 | 🟢 Nominal | `C:9 M:0 X:0` | `C5.7` |
| `2026-06-10` | **161** | 188.6 sfu | Kp 1.89 | 🟢 Quiet | `C:6 M:0 X:0` | `C3.9` |
| `2026-06-11` | **143** | 179.3 sfu | Kp 0.96 | 🟢 Quiet | `C:5 M:0 X:0` | `C8.8` |
| `2026-06-12` | **152** | 184.9 sfu | Kp 1.19 | 🟢 Quiet | `C:7 M:0 X:0` | `C5.2` |
| `2026-06-13` | **155** | 179.4 sfu | Kp 4.28 | 🟡 Active | `C:6 M:0 X:0` | `C6.2` |
| `2026-06-14` | **136** | 167.5 sfu | Kp 0.72 | 🟢 Quiet | `C:6 M:0 X:0` | `C7.2` |
| `2026-06-15` | **139** | 160.4 sfu | Kp 2.59 | 🟢 Nominal | `C:7 M:0 X:0` | `C8.6` |
