...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`184`** | `[▰▰▰▰▰▰▰▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`207.7 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.54`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`M2.4 @ 15:35 UTC`** | `C:9  M:2  X:0` | **🟡 MODERATE / ELEVATED** |
