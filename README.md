...
| **10.7 cm Solar Radio Flux** | **`180.5 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`1.48`** | `[▰▰▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`M5.3 @ 12:02 UTC`** | `C:9  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
