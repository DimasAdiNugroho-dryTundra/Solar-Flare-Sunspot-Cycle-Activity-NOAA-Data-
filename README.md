...
| **10.7 cm Solar Radio Flux** | **`180.3 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.52`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`M7.0 @ 19:03 UTC`** | `C:8  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
