...
| **10.7 cm Solar Radio Flux** | **`179.4 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`4.28`** | `[▰▰▰▰▰▱▱▱▱▱]` | **G0 (Active)** — Auroral oval expands to high latitudes |
| **24h Solar Flare Activity** | **`C6.2 @ 10:16 UTC`** | `C:6  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2026-06-07` | **165** | 184.9 sfu | Kp 1.93 | 🟢 Quiet | `C:8 M:2 X:0` | `M7.3` |
| `2026-06-08` | **160** | 189.2 sfu | Kp 0.83 | 🟢 Quiet | `C:8 M:0 X:0` | `C2.8` |
