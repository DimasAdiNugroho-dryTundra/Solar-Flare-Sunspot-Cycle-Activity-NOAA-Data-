...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`161`** | `[▰▰▰▰▰▰▱▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`188.4 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`3.87`** | `[▰▰▰▰▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C7.2 @ 23:11 UTC`** | `C:9  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| `2026-04-07` | **153** | 180.3 sfu | Kp 5.09 | 🟠 G1 Minor | `C:5 M:0 X:0` | `C1.8` |
| `2026-04-08` | **161** | 185.4 sfu | Kp 1.33 | 🟢 Quiet | `C:9 M:0 X:0` | `C2.5` |
| `2026-04-09` | **170** | 197.2 sfu | Kp 1.19 | 🟢 Quiet | `C:7 M:1 X:0` | `M8.2` |
| `2026-04-10` | **166** | 186.4 sfu | Kp 2.45 | 🟢 Nominal | `C:9 M:1 X:0` | `M2.6` |
| `2026-04-11` | **161** | 188.4 sfu | Kp 3.87 | 🟢 Nominal | `C:9 M:0 X:0` | `C7.2` |
