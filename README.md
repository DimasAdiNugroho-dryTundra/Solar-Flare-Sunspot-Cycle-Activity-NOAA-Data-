...
| **10.7 cm Solar Radio Flux** | **`155.3 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`1.70`** | `[▰▰▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`C6.8 @ 17:07 UTC`** | `C:5  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-10-13` | **144** | 166.7 sfu | Kp 3.74 | 🟢 Nominal | `C:7 M:0 X:0` | `C2.4` |
| `2025-10-14` | **155** | 165.0 sfu | Kp 2.05 | 🟢 Nominal | `C:7 M:1 X:0` | `M5.2` |
| `2025-10-15` | **149** | 162.3 sfu | Kp 1.83 | 🟢 Quiet | `C:6 M:1 X:0` | `M8.1` |
