...
| **10.7 cm Solar Radio Flux** | **`135.4 sfu`** | `[▰▰▰▰▰▱▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`5.10`** | `[▰▰▰▰▰▰▱▱▱▱]` | **G1 (Minor Storm)** — Weak power grid fluctuations; aurora at ~60° |
| **24h Solar Flare Activity** | **`C2.3 @ 06:10 UTC`** | `C:7  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
