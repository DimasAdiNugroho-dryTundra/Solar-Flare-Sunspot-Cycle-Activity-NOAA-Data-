...
| **10.7 cm Solar Radio Flux** | **`191.9 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`4.54`** | `[▰▰▰▰▰▱▱▱▱▱]` | **G0 (Active)** — Auroral oval expands to high latitudes |
| **24h Solar Flare Activity** | **`C8.7 @ 05:46 UTC`** | `C:10  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2026-09-13` | **138** | 159.9 sfu | Kp 1.87 | 🟢 Quiet | `C:7 M:0 X:0` | `C8.2` |
| `2026-09-14` | **127** | 156.1 sfu | Kp 4.32 | 🟡 Active | `C:8 M:0 X:0` | `C3.9` |
