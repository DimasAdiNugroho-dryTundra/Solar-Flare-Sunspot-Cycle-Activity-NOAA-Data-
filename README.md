...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`132`** | `[▰▰▰▰▰▱▱▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`151.0 sfu`** | `[▰▰▰▰▰▱▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`7.14`** | `[▰▰▰▰▰▰▰▰▱▱]` | **G3 (Strong Storm)** — Voltage corrections needed; satellite orientation |
| **24h Solar Flare Activity** | **`C4.7 @ 02:56 UTC`** | `C:8  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
