...
| **10.7 cm Solar Radio Flux** | **`195.4 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`4.54`** | `[▰▰▰▰▰▱▱▱▱▱]` | **G0 (Active)** — Auroral oval expands to high latitudes |
| **24h Solar Flare Activity** | **`M7.0 @ 23:53 UTC`** | `C:7  M:2  X:0` | **🟡 MODERATE / ELEVATED** |
...
| `2025-11-27` | **176** | 191.5 sfu | Kp 1.20 | 🟢 Quiet | `C:9 M:1 X:0` | `M3.0` |
| `2025-11-28` | **174** | 195.1 sfu | Kp 1.71 | 🟢 Quiet | `C:9 M:0 X:0` | `C2.5` |
