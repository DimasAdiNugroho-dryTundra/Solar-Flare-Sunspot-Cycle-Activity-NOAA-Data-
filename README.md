...
| **Planetary Kp-Index (3h Max)** | **`5.87`** | `[▰▰▰▰▰▰▰▱▱▱]` | **G1 (Minor Storm)** — Weak power grid fluctuations; aurora at ~60° |
| **24h Solar Flare Activity** | **`C3.1 @ 23:10 UTC`** | `C:6  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
