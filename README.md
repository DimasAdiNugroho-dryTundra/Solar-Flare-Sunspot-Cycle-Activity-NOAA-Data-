...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`168`** | `[▰▰▰▰▰▰▰▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`183.8 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.52`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`M4.3 @ 05:10 UTC`** | `C:7  M:2  X:0` | **🟡 MODERATE / ELEVATED** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-11-01` | **163** | 183.8 sfu | Kp 2.22 | 🟢 Nominal | `C:8 M:0 X:0` | `C1.2` |
| `2025-11-02` | **161** | 190.4 sfu | Kp 2.77 | 🟢 Nominal | `C:10 M:1 X:0` | `M7.5` |
| `2025-11-03` | **175** | 198.1 sfu | Kp 2.16 | 🟢 Nominal | `C:6 M:0 X:0` | `C9.3` |
| `2025-11-04` | **173** | 190.6 sfu | Kp 4.13 | 🟡 Active | `C:9 M:0 X:0` | `C2.9` |
| `2025-11-05` | **174** | 200.1 sfu | Kp 2.68 | 🟢 Nominal | `C:8 M:1 X:0` | `M6.0` |
| `2025-11-06` | **158** | 179.7 sfu | Kp 2.63 | 🟢 Nominal | `C:5 M:0 X:0` | `C1.4` |
| `2025-11-07` | **168** | 183.8 sfu | Kp 2.52 | 🟢 Nominal | `C:7 M:2 X:0` | `M4.3` |
