...
| **10.7 cm Solar Radio Flux** | **`153.6 sfu`** | `[▰▰▰▰▰▱▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`7.17`** | `[▰▰▰▰▰▰▰▰▱▱]` | **G3 (Strong Storm)** — Voltage corrections needed; satellite orientation |
| **24h Solar Flare Activity** | **`C3.3 @ 07:16 UTC`** | `C:9  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
