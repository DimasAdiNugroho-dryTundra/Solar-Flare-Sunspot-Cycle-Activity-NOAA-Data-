...
| **10.7 cm Solar Radio Flux** | **`172.9 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`1.54`** | `[▰▰▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`C9.4 @ 06:34 UTC`** | `C:5  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
