...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`139`** | `[▰▰▰▰▰▰▱▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`162.7 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`3.60`** | `[▰▰▰▰▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C9.5 @ 21:54 UTC`** | `C:7  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2026-08-02` | **153** | 181.0 sfu | Kp 3.60 | 🟢 Nominal | `C:5 M:1 X:0` | `M2.7` |
| `2026-08-03` | **153** | 186.1 sfu | Kp 4.13 | 🟡 Active | `C:9 M:1 X:0` | `M6.2` |
| `2026-08-04` | **143** | 181.1 sfu | Kp 5.02 | 🟠 G1 Minor | `C:6 M:0 X:0` | `C3.6` |
| `2026-08-05` | **149** | 178.6 sfu | Kp 1.28 | 🟢 Quiet | `C:7 M:0 X:0` | `C3.8` |
| `2026-08-06` | **159** | 181.8 sfu | Kp 2.41 | 🟢 Nominal | `C:7 M:0 X:0` | `C8.3` |
| `2026-08-07` | **151** | 178.2 sfu | Kp 1.99 | 🟢 Quiet | `C:5 M:0 X:0` | `C3.0` |
| `2026-08-08` | **139** | 162.7 sfu | Kp 3.60 | 🟢 Nominal | `C:7 M:0 X:0` | `C9.5` |
