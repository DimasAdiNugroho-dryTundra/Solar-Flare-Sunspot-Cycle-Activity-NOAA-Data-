...
| **Planetary Kp-Index (3h Max)** | **`2.17`** | `[▰▰▱▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C8.7 @ 01:43 UTC`** | `C:8  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| `2026-01-16` | **183** | 200.0 sfu | Kp 0.76 | 🟢 Quiet | `C:6 M:0 X:0` | `C6.9` |
