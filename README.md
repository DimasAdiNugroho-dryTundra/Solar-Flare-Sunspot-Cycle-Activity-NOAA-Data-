...
| **10.7 cm Solar Radio Flux** | **`168.7 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.72`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C3.1 @ 18:35 UTC`** | `C:8  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| `2025-07-02` | **138** | 152.9 sfu | Kp 1.34 | 🟢 Quiet | `C:7 M:0 X:0` | `C9.3` |
| `2025-07-03` | **154** | 168.7 sfu | Kp 2.72 | 🟢 Nominal | `C:8 M:0 X:0` | `C3.1` |
