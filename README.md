...
| **Planetary Kp-Index (3h Max)** | **`1.24`** | `[▰▱▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`M4.6 @ 11:36 UTC`** | `C:7  M:2  X:0` | **🟡 MODERATE / ELEVATED** |
...
| `2025-09-26` | **169** | 183.8 sfu | Kp 1.24 | 🟢 Quiet | `C:7 M:2 X:0` | `M4.6` |
