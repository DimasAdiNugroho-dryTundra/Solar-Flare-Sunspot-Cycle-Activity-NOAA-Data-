...
| **10.7 cm Solar Radio Flux** | **`186.1 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`4.13`** | `[▰▰▰▰▰▱▱▱▱▱]` | **G0 (Active)** — Auroral oval expands to high latitudes |
| **24h Solar Flare Activity** | **`M6.2 @ 09:04 UTC`** | `C:9  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
...
| `2026-07-30` | **142** | 170.2 sfu | Kp 1.28 | 🟢 Quiet | `C:9 M:0 X:0` | `C5.6` |
