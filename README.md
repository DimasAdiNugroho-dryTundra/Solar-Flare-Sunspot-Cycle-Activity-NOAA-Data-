...
| **10.7 cm Solar Radio Flux** | **`157.5 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`5.68`** | `[▰▰▰▰▰▰▱▱▱▱]` | **G1 (Minor Storm)** — Weak power grid fluctuations; aurora at ~60° |
| **24h Solar Flare Activity** | **`C2.3 @ 18:57 UTC`** | `C:5  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
