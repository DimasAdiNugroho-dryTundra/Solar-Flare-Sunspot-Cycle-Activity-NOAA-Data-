...
| **10.7 cm Solar Radio Flux** | **`199.2 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`1.47`** | `[▰▰▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`C6.6 @ 08:20 UTC`** | `C:9  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
