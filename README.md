...
| **10.7 cm Solar Radio Flux** | **`138.3 sfu`** | `[▰▰▰▰▰▱▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.78`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C3.3 @ 01:08 UTC`** | `C:8  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2026-03-24` | **143** | 177.9 sfu | Kp 2.09 | 🟢 Nominal | `C:5 M:1 X:0` | `M3.4` |
| `2026-03-25` | **139** | 160.1 sfu | Kp 2.05 | 🟢 Nominal | `C:6 M:0 X:0` | `C2.8` |
