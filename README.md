...
| **10.7 cm Solar Radio Flux** | **`197.2 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`1.19`** | `[▰▱▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`M8.2 @ 21:30 UTC`** | `C:7  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
