...
| **Planetary Kp-Index (3h Max)** | **`3.80`** | `[▰▰▰▰▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C7.9 @ 09:03 UTC`** | `C:9  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| `2026-01-27` | **191** | 213.8 sfu | Kp 1.05 | 🟢 Quiet | `C:10 M:0 X:0` | `C5.9` |
| `2026-01-28` | **186** | 208.5 sfu | Kp 3.80 | 🟢 Nominal | `C:9 M:0 X:0` | `C7.9` |
