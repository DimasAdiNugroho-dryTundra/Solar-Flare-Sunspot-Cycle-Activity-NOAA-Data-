...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`205`** | `[▰▰▰▰▰▰▰▰▱▱]` | Active solar disk complex; multiple bipoles |
...
| **24h Solar Flare Activity** | **`M7.4 @ 17:05 UTC`** | `C:9  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
