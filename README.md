...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`164`** | `[▰▰▰▰▰▰▰▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`194.9 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`3.62`** | `[▰▰▰▰▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`M6.9 @ 07:52 UTC`** | `C:10  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2026-09-15` | **130** | 156.7 sfu | Kp 3.65 | 🟢 Nominal | `C:6 M:0 X:0` | `C6.6` |
| `2026-09-16` | **156** | 173.9 sfu | Kp 3.67 | 🟢 Nominal | `C:7 M:2 X:0` | `M1.4` |
| `2026-09-17` | **156** | 173.8 sfu | Kp 0.82 | 🟢 Quiet | `C:6 M:0 X:0` | `C3.7` |
| `2026-09-18` | **145** | 179.7 sfu | Kp 4.04 | 🟡 Active | `C:9 M:0 X:0` | `C4.9` |
| `2026-09-19` | **163** | 191.9 sfu | Kp 4.54 | 🟡 Active | `C:10 M:0 X:0` | `C8.7` |
| `2026-09-20` | **146** | 183.0 sfu | Kp 1.14 | 🟢 Quiet | `C:6 M:1 X:0` | `M4.6` |
| `2026-09-21` | **164** | 194.9 sfu | Kp 3.62 | 🟢 Nominal | `C:10 M:1 X:0` | `M6.9` |
