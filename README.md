...
| **10.7 cm Solar Radio Flux** | **`216.6 sfu`** | `[▰▰▰▰▰▰▰▰▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`1.09`** | `[▰▱▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`M3.8 @ 09:37 UTC`** | `C:8  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
