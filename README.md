...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`144`** | `[▰▰▰▰▰▰▱▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`171.8 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`3.24`** | `[▰▰▰▰▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`M8.0 @ 15:35 UTC`** | `C:9  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
...
| `2026-08-21` | **144** | 171.8 sfu | Kp 3.24 | 🟢 Nominal | `C:9 M:1 X:0` | `M8.0` |
