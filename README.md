...
[![Geomagnetic Status](https://img.shields.io/badge/Geomagnetic%20Activity-🟢%20Nominal-brightgreen?style=for-the-badge&logo=speedtest&logoColor=white)](https://www.swpc.noaa.gov/products/planetary-k-index)
...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`192`** | `[▰▰▰▰▰▰▰▰▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`215.2 sfu`** | `[▰▰▰▰▰▰▰▰▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`3.58`** | `[▰▰▰▰▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C9.4 @ 17:54 UTC`** | `C:7  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-08-31` | **186** | 204.4 sfu | Kp 2.68 | 🟢 Nominal | `C:10 M:2 X:0` | `M5.9` |
| `2025-09-01` | **210** | 219.5 sfu | Kp 2.12 | 🟢 Nominal | `C:9 M:0 X:0` | `C6.0` |
| `2025-09-02` | **210** | 218.6 sfu | Kp 7.24 | 🔴 G3 Strong | `C:10 M:0 X:0` | `C1.6` |
| `2025-09-03` | **206** | 222.6 sfu | Kp 3.22 | 🟢 Nominal | `C:11 M:0 X:0` | `C9.4` |
| `2025-09-04` | **208** | 217.5 sfu | Kp 2.45 | 🟢 Nominal | `C:8 M:0 X:0` | `C3.6` |
| `2025-09-05` | **191** | 211.9 sfu | Kp 3.74 | 🟢 Nominal | `C:9 M:1 X:0` | `M7.8` |
| `2025-09-06` | **192** | 215.2 sfu | Kp 3.58 | 🟢 Nominal | `C:7 M:0 X:0` | `C9.4` |
