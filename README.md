...
| **Planetary Kp-Index (3h Max)** | **`1.30`** | `[▰▱▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`M8.7 @ 08:23 UTC`** | `C:8  M:2  X:0` | **🟡 MODERATE / ELEVATED** |
