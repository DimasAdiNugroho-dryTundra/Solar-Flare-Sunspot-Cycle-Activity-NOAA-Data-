...
| **10.7 cm Solar Radio Flux** | **`170.4 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`4.59`** | `[▰▰▰▰▰▱▱▱▱▱]` | **G0 (Active)** — Auroral oval expands to high latitudes |
| **24h Solar Flare Activity** | **`C8.6 @ 13:41 UTC`** | `C:5  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| `2026-02-26` | **140** | 170.4 sfu | Kp 4.59 | 🟡 Active | `C:5 M:0 X:0` | `C8.6` |
