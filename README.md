...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`208`** | `[▰▰▰▰▰▰▰▰▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`228.2 sfu`** | `[▰▰▰▰▰▰▰▰▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`6.62`** | `[▰▰▰▰▰▰▰▱▱▱]` | **G2 (Moderate Storm)** — High-latitude power alarms; satellite drag |
| **24h Solar Flare Activity** | **`C5.5 @ 15:11 UTC`** | `C:10  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-08-09` | **194** | 211.6 sfu | Kp 4.30 | 🟡 Active | `C:9 M:2 X:0` | `M6.3` |
| `2025-08-10` | **191** | 209.9 sfu | Kp 2.77 | 🟢 Nominal | `C:9 M:0 X:0` | `C2.8` |
| `2025-08-11` | **197** | 215.1 sfu | Kp 1.18 | 🟢 Quiet | `C:9 M:0 X:0` | `C4.5` |
| `2025-08-12` | **184** | 207.7 sfu | Kp 2.54 | 🟢 Nominal | `C:9 M:2 X:0` | `M2.4` |
| `2025-08-13` | **189** | 203.7 sfu | Kp 1.18 | 🟢 Quiet | `C:6 M:0 X:0` | `C1.1` |
| `2025-08-14` | **188** | 208.1 sfu | Kp 2.09 | 🟢 Nominal | `C:10 M:0 X:0` | `C8.2` |
| `2025-08-15` | **208** | 228.2 sfu | Kp 6.62 | 🔴 G2 Moderate | `C:10 M:0 X:0` | `C5.5` |
