...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`160`** | `[▰▰▰▰▰▰▱▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`188.7 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`3.53`** | `[▰▰▰▰▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`M4.8 @ 13:28 UTC`** | `C:6  M:2  X:0` | **🟡 MODERATE / ELEVATED** |
...
| `2025-11-24` | **169** | 198.8 sfu | Kp 1.22 | 🟢 Quiet | `C:9 M:1 X:0` | `M5.5` |
| `2025-11-25` | **164** | 190.6 sfu | Kp 1.52 | 🟢 Quiet | `C:6 M:1 X:0` | `M8.6` |
| `2025-11-26` | **160** | 188.7 sfu | Kp 3.53 | 🟢 Nominal | `C:6 M:2 X:0` | `M4.8` |
