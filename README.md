...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`111`** | `[▰▰▰▰▱▱▱▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`136.7 sfu`** | `[▰▰▰▰▰▱▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`6.99`** | `[▰▰▰▰▰▰▰▰▱▱]` | **G2 (Moderate Storm)** — High-latitude power alarms; satellite drag |
| **24h Solar Flare Activity** | **`C4.3 @ 13:48 UTC`** | `C:7  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2026-08-10` | **117** | 138.1 sfu | Kp 0.70 | 🟢 Quiet | `C:5 M:0 X:0` | `C8.1` |
| `2026-08-11` | **114** | 142.5 sfu | Kp 1.53 | 🟢 Quiet | `C:5 M:0 X:0` | `C6.8` |
| `2026-08-12` | **102** | 131.8 sfu | Kp 3.62 | 🟢 Nominal | `C:4 M:0 X:0` | `C6.2` |
| `2026-08-13` | **112** | 131.6 sfu | Kp 1.39 | 🟢 Quiet | `C:7 M:0 X:0` | `C5.1` |
| `2026-08-14` | **122** | 137.1 sfu | Kp 2.80 | 🟢 Nominal | `C:9 M:0 X:0` | `C6.0` |
| `2026-08-15` | **113** | 141.7 sfu | Kp 2.63 | 🟢 Nominal | `C:8 M:0 X:0` | `C2.2` |
| `2026-08-16` | **111** | 136.7 sfu | Kp 6.99 | 🔴 G2 Moderate | `C:7 M:0 X:0` | `C4.3` |
