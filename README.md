...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`165`** | `[▰▰▰▰▰▰▰▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`177.9 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.40`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C8.7 @ 01:23 UTC`** | `C:8  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-09-14` | **205** | 210.4 sfu | Kp 1.94 | 🟢 Quiet | `C:9 M:1 X:0` | `M7.4` |
| `2025-09-15` | **177** | 192.3 sfu | Kp 1.75 | 🟢 Quiet | `C:7 M:0 X:0` | `C5.4` |
| `2025-09-16` | **180** | 187.4 sfu | Kp 2.23 | 🟢 Nominal | `C:9 M:0 X:0` | `C8.9` |
| `2025-09-17` | **167** | 173.1 sfu | Kp 2.63 | 🟢 Nominal | `C:10 M:0 X:0` | `C2.6` |
| `2025-09-18` | **172** | 178.6 sfu | Kp 4.17 | 🟡 Active | `C:8 M:0 X:0` | `C1.5` |
