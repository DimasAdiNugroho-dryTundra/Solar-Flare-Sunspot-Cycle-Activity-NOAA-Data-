...
| **10.7 cm Solar Radio Flux** | **`208.1 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.09`** | `[▰▰▱▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C8.2 @ 15:24 UTC`** | `C:10  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
