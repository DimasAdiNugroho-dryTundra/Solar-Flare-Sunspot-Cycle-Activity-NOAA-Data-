...
| **Planetary Kp-Index (3h Max)** | **`2.22`** | `[▰▰▱▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C1.2 @ 07:49 UTC`** | `C:8  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-10-26` | **162** | 185.8 sfu | Kp 1.88 | 🟢 Quiet | `C:6 M:1 X:0` | `M1.4` |
