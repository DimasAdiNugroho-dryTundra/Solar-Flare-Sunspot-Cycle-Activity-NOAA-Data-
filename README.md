...
| **10.7 cm Solar Radio Flux** | **`169.6 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`1.82`** | `[▰▰▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`M6.0 @ 13:37 UTC`** | `C:5  M:2  X:0` | **🟡 MODERATE / ELEVATED** |
