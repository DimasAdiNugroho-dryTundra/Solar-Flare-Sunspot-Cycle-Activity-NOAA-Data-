...
| **10.7 cm Solar Radio Flux** | **`178.7 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.31`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`M7.2 @ 11:55 UTC`** | `C:8  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2026-05-31` | **159** | 190.1 sfu | Kp 1.11 | 🟢 Quiet | `C:8 M:0 X:0` | `C7.3` |
| `2026-06-01` | **149** | 183.5 sfu | Kp 2.27 | 🟢 Nominal | `C:5 M:1 X:0` | `M1.7` |
| `2026-06-02` | **153** | 175.7 sfu | Kp 2.98 | 🟢 Nominal | `C:9 M:0 X:0` | `C9.3` |
| `2026-06-03` | **163** | 188.2 sfu | Kp 0.96 | 🟢 Quiet | `C:9 M:0 X:0` | `C3.0` |
| `2026-06-04` | **164** | 190.9 sfu | Kp 1.76 | 🟢 Quiet | `C:7 M:1 X:0` | `M5.1` |
| `2026-06-05` | **162** | 181.7 sfu | Kp 1.17 | 🟢 Quiet | `C:8 M:0 X:0` | `C3.1` |
| `2026-06-06` | **155** | 178.7 sfu | Kp 2.31 | 🟢 Nominal | `C:8 M:1 X:0` | `M7.2` |
