...
| **10.7 cm Solar Radio Flux** | **`200.6 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`4.26`** | `[▰▰▰▰▰▱▱▱▱▱]` | **G0 (Active)** — Auroral oval expands to high latitudes |
| **24h Solar Flare Activity** | **`C5.4 @ 01:11 UTC`** | `C:8  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| `2025-07-16` | **185** | 211.4 sfu | Kp 1.90 | 🟢 Quiet | `C:9 M:0 X:0` | `C4.5` |
| `2025-07-17` | **175** | 200.6 sfu | Kp 4.26 | 🟡 Active | `C:8 M:0 X:0` | `C5.4` |
