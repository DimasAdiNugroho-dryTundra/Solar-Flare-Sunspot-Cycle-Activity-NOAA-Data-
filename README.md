...
| **10.7 cm Solar Radio Flux** | **`206.8 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`1.43`** | `[▰▰▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`C1.6 @ 19:55 UTC`** | `C:10  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
