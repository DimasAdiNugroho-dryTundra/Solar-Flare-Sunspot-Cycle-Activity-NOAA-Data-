...
| **10.7 cm Solar Radio Flux** | **`192.4 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`1.76`** | `[▰▰▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`M8.4 @ 14:00 UTC`** | `C:8  M:2  X:0` | **🟡 MODERATE / ELEVATED** |
