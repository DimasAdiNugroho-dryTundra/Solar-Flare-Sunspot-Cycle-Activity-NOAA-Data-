...
| **10.7 cm Solar Radio Flux** | **`164.4 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`3.46`** | `[▰▰▰▰▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`M1.8 @ 04:18 UTC`** | `C:6  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-06-23` | **175** | 202.9 sfu | Kp 0.76 | 🟢 Quiet | `C:6 M:2 X:0` | `M6.8` |
