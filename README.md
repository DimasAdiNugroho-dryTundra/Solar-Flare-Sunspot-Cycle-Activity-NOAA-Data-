...
| **10.7 cm Solar Radio Flux** | **`193.2 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.61`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C5.2 @ 19:46 UTC`** | `C:6  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| `2025-12-16` | **160** | 183.0 sfu | Kp 1.30 | 🟢 Quiet | `C:8 M:2 X:0` | `M8.7` |
| `2025-12-17` | **176** | 190.7 sfu | Kp 1.47 | 🟢 Quiet | `C:6 M:1 X:0` | `M6.8` |
| `2025-12-18` | **168** | 193.2 sfu | Kp 2.61 | 🟢 Nominal | `C:6 M:0 X:0` | `C5.2` |
