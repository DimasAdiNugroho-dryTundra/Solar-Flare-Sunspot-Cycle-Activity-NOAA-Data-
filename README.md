...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`116`** | `[▰▰▰▰▰▱▱▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`139.4 sfu`** | `[▰▰▰▰▰▱▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`4.82`** | `[▰▰▰▰▰▱▱▱▱▱]` | **G0 (Active)** — Auroral oval expands to high latitudes |
| **24h Solar Flare Activity** | **`C8.1 @ 22:33 UTC`** | `C:4  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2026-02-28` | **115** | 135.9 sfu | Kp 2.18 | 🟢 Nominal | `C:5 M:0 X:0` | `C3.5` |
| `2026-03-01` | **104** | 127.9 sfu | Kp 1.93 | 🟢 Quiet | `C:5 M:0 X:0` | `C8.4` |
| `2026-03-02` | **98** | 119.1 sfu | Kp 1.75 | 🟢 Quiet | `C:7 M:0 X:0` | `C1.2` |
| `2026-03-03` | **97** | 118.0 sfu | Kp 3.35 | 🟢 Nominal | `C:5 M:0 X:0` | `C6.6` |
| `2026-03-04` | **100** | 120.8 sfu | Kp 2.40 | 🟢 Nominal | `C:7 M:0 X:0` | `C9.1` |
| `2026-03-05` | **118** | 142.7 sfu | Kp 2.50 | 🟢 Nominal | `C:4 M:0 X:0` | `C2.7` |
| `2026-03-06` | **116** | 139.4 sfu | Kp 4.82 | 🟡 Active | `C:4 M:0 X:0` | `C8.1` |
