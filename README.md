...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`206`** | `[▰▰▰▰▰▰▰▰▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`222.6 sfu`** | `[▰▰▰▰▰▰▰▰▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`3.22`** | `[▰▰▰▰▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C9.4 @ 18:15 UTC`** | `C:11  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-08-28` | **166** | 174.6 sfu | Kp 1.07 | 🟢 Quiet | `C:7 M:1 X:0` | `M2.4` |
