...
| **10.7 cm Solar Radio Flux** | **`181.8 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.41`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C8.3 @ 21:28 UTC`** | `C:7  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2026-07-31` | **152** | 183.1 sfu | Kp 1.33 | 🟢 Quiet | `C:7 M:0 X:0` | `C7.7` |
| `2026-08-01` | **151** | 175.0 sfu | Kp 0.97 | 🟢 Quiet | `C:5 M:1 X:0` | `M4.0` |
