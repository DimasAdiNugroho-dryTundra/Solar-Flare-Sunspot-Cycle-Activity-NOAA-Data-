...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`166`** | `[▰▰▰▰▰▰▰▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`175.0 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.56`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`M5.7 @ 20:37 UTC`** | `C:6  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
...
| `2025-08-21` | **166** | 175.0 sfu | Kp 2.56 | 🟢 Nominal | `C:6 M:1 X:0` | `M5.7` |
