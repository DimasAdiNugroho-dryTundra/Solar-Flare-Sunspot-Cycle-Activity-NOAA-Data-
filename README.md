...
| **10.7 cm Solar Radio Flux** | **`147.3 sfu`** | `[▰▰▰▰▰▱▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.64`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C7.9 @ 00:56 UTC`** | `C:5  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| `2025-12-06` | **164** | 188.8 sfu | Kp 0.94 | 🟢 Quiet | `C:9 M:0 X:0` | `C9.4` |
