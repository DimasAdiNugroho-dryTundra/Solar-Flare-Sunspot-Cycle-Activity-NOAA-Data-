...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`129`** | `[▰▰▰▰▰▱▱▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`145.5 sfu`** | `[▰▰▰▰▰▱▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`4.60`** | `[▰▰▰▰▰▱▱▱▱▱]` | **G0 (Active)** — Auroral oval expands to high latitudes |
| **24h Solar Flare Activity** | **`C3.3 @ 02:01 UTC`** | `C:9  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| `2026-01-31` | **148** | 171.5 sfu | Kp 1.99 | 🟢 Quiet | `C:8 M:0 X:0` | `C2.5` |
