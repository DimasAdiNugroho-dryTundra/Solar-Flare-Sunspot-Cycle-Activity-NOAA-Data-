...
| **10.7 cm Solar Radio Flux** | **`164.1 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`0.83`** | `[▰▱▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`C5.1 @ 18:49 UTC`** | `C:9  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
