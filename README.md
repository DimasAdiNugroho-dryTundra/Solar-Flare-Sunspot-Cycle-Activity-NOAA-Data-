...
| **10.7 cm Solar Radio Flux** | **`205.9 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`3.20`** | `[▰▰▰▰▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C8.5 @ 05:41 UTC`** | `C:10  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-12-19` | **182** | 200.8 sfu | Kp 3.88 | 🟢 Nominal | `C:8 M:1 X:0` | `M1.0` |
| `2025-12-20` | **185** | 197.2 sfu | Kp 0.83 | 🟢 Quiet | `C:6 M:0 X:0` | `C6.0` |
