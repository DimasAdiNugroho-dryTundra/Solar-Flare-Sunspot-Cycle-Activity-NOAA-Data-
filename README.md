...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`187`** | `[▰▰▰▰▰▰▰▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`196.2 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`3.89`** | `[▰▰▰▰▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`M2.7 @ 10:33 UTC`** | `C:10  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-09-19` | **158** | 167.0 sfu | Kp 2.17 | 🟢 Nominal | `C:9 M:0 X:0` | `C3.0` |
| `2025-09-20` | **165** | 177.9 sfu | Kp 2.40 | 🟢 Nominal | `C:8 M:0 X:0` | `C8.7` |
| `2025-09-21` | **161** | 164.9 sfu | Kp 7.28 | 🔴 G3 Strong | `C:8 M:0 X:0` | `C3.2` |
| `2025-09-22` | **169** | 177.4 sfu | Kp 1.80 | 🟢 Quiet | `C:10 M:0 X:0` | `C6.7` |
| `2025-09-23` | **150** | 160.9 sfu | Kp 1.72 | 🟢 Quiet | `C:9 M:1 X:0` | `M7.1` |
| `2025-09-24` | **162** | 178.0 sfu | Kp 0.75 | 🟢 Quiet | `C:6 M:1 X:0` | `M6.7` |
| `2025-09-25` | **187** | 196.2 sfu | Kp 3.89 | 🟢 Nominal | `C:10 M:1 X:0` | `M2.7` |
