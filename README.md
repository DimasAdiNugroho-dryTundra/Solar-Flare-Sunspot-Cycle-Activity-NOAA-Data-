...
| **10.7 cm Solar Radio Flux** | **`188.1 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`0.91`** | `[▰▱▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`M7.4 @ 23:33 UTC`** | `C:6  M:2  X:0` | **🟡 MODERATE / ELEVATED** |
