...
| **10.7 cm Solar Radio Flux** | **`184.9 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`1.93`** | `[▰▰▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`M7.3 @ 18:20 UTC`** | `C:8  M:2  X:0` | **🟡 MODERATE / ELEVATED** |
