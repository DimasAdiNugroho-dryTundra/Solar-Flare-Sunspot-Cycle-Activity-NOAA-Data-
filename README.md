...
| **10.7 cm Solar Radio Flux** | **`189.3 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`0.75`** | `[▰▱▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`M3.3 @ 22:19 UTC`** | `C:8  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
