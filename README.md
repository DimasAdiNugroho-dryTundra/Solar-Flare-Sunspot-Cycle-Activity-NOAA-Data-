...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`176`** | `[▰▰▰▰▰▰▰▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`202.3 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.62`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C1.6 @ 06:38 UTC`** | `C:6  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| `2026-01-24` | **175** | 202.8 sfu | Kp 1.47 | 🟢 Quiet | `C:8 M:1 X:0` | `M6.0` |
| `2026-01-25` | **183** | 203.8 sfu | Kp 3.53 | 🟢 Nominal | `C:6 M:0 X:0` | `C4.9` |
| `2026-01-26` | **176** | 202.3 sfu | Kp 2.62 | 🟢 Nominal | `C:6 M:0 X:0` | `C1.6` |
