...
| **10.7 cm Solar Radio Flux** | **`178.0 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`0.75`** | `[▰▱▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`M6.7 @ 11:18 UTC`** | `C:6  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
