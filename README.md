...
| **10.7 cm Solar Radio Flux** | **`152.7 sfu`** | `[▰▰▰▰▰▱▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`0.71`** | `[▰▱▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`C7.8 @ 11:24 UTC`** | `C:8  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-10-12` | **157** | 176.2 sfu | Kp 1.29 | 🟢 Quiet | `C:9 M:2 X:0` | `M4.6` |
