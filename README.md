...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`157`** | `[▰▰▰▰▰▰▱▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`177.1 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`3.10`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C3.7 @ 04:25 UTC`** | `C:5  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| `2026-05-26` | **124** | 149.4 sfu | Kp 1.26 | 🟢 Quiet | `C:6 M:0 X:0` | `C2.1` |
| `2026-05-27` | **140** | 164.8 sfu | Kp 1.39 | 🟢 Quiet | `C:5 M:0 X:0` | `C1.7` |
| `2026-05-28` | **150** | 173.3 sfu | Kp 3.10 | 🟢 Nominal | `C:6 M:1 X:0` | `M4.4` |
| `2026-05-29` | **157** | 177.1 sfu | Kp 3.10 | 🟢 Nominal | `C:5 M:0 X:0` | `C3.7` |
