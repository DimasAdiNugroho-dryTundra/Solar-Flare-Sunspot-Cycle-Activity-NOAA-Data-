...
| **10.7 cm Solar Radio Flux** | **`194.4 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`4.41`** | `[▰▰▰▰▰▱▱▱▱▱]` | **G0 (Active)** — Auroral oval expands to high latitudes |
| **24h Solar Flare Activity** | **`M1.6 @ 13:52 UTC`** | `C:6  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-10-24` | **160** | 176.5 sfu | Kp 1.00 | 🟢 Quiet | `C:6 M:1 X:0` | `M6.7` |
| `2025-10-25` | **174** | 188.4 sfu | Kp 1.10 | 🟢 Quiet | `C:6 M:0 X:0` | `C2.4` |
