...
| **10.7 cm Solar Radio Flux** | **`210.2 sfu`** | `[▰▰▰▰▰▰▰▰▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`1.80`** | `[▰▰▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`M1.8 @ 05:00 UTC`** | `C:10  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
