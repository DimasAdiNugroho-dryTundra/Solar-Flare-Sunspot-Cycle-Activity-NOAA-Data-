...
| **Planetary Kp-Index (3h Max)** | **`5.33`** | `[▰▰▰▰▰▰▱▱▱▱]` | **G1 (Minor Storm)** — Weak power grid fluctuations; aurora at ~60° |
| **24h Solar Flare Activity** | **`M4.2 @ 03:14 UTC`** | `C:9  M:2  X:0` | **🟡 MODERATE / ELEVATED** |
