...
| **10.7 cm Solar Radio Flux** | **`208.3 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`1.55`** | `[▰▰▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`M2.7 @ 12:41 UTC`** | `C:8  M:2  X:0` | **🟡 MODERATE / ELEVATED** |
