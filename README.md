...
| **10.7 cm Solar Radio Flux** | **`179.0 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.80`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C2.8 @ 13:26 UTC`** | `C:6  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2026-07-03` | **144** | 181.4 sfu | Kp 3.19 | 🟢 Nominal | `C:8 M:0 X:0` | `C3.4` |
| `2026-07-04` | **150** | 178.6 sfu | Kp 1.37 | 🟢 Quiet | `C:7 M:1 X:0` | `M4.4` |
