...
| **10.7 cm Solar Radio Flux** | **`218.6 sfu`** | `[▰▰▰▰▰▰▰▰▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`7.24`** | `[▰▰▰▰▰▰▰▰▱▱]` | **G3 (Strong Storm)** — Voltage corrections needed; satellite orientation |
| **24h Solar Flare Activity** | **`C1.6 @ 18:46 UTC`** | `C:10  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
