...
| **10.7 cm Solar Radio Flux** | **`191.4 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.90`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`M1.7 @ 18:18 UTC`** | `C:7  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
...
| `2026-01-29` | **168** | 191.4 sfu | Kp 2.90 | 🟢 Nominal | `C:7 M:1 X:0` | `M1.7` |
