...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`115`** | `[▰▰▰▰▰▱▱▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`135.9 sfu`** | `[▰▰▰▰▰▱▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.18`** | `[▰▰▱▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C3.5 @ 14:24 UTC`** | `C:5  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| `2026-02-27` | **133** | 155.0 sfu | Kp 1.33 | 🟢 Quiet | `C:6 M:0 X:0` | `C8.6` |
