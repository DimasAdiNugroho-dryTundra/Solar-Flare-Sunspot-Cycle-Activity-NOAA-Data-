...
| **Planetary Kp-Index (3h Max)** | **`5.09`** | `[▰▰▰▰▰▰▱▱▱▱]` | **G1 (Minor Storm)** — Weak power grid fluctuations; aurora at ~60° |
| **24h Solar Flare Activity** | **`C1.8 @ 21:58 UTC`** | `C:5  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
