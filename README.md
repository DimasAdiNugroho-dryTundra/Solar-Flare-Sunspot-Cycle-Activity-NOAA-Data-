...
| **10.7 cm Solar Radio Flux** | **`203.4 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`3.07`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C5.2 @ 11:11 UTC`** | `C:7  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-06-05` | **145** | 161.6 sfu | Kp 2.96 | 🟢 Nominal | `C:6 M:0 X:0` | `C8.0` |
| `2025-06-06` | **163** | 170.2 sfu | Kp 1.49 | 🟢 Quiet | `C:9 M:1 X:0` | `M1.6` |
| `2025-06-07` | **176** | 181.7 sfu | Kp 1.83 | 🟢 Quiet | `C:7 M:1 X:0` | `M7.2` |
| `2025-06-08` | **163** | 174.5 sfu | Kp 2.64 | 🟢 Nominal | `C:10 M:0 X:0` | `C8.0` |
| `2025-06-09` | **173** | 185.6 sfu | Kp 3.02 | 🟢 Nominal | `C:9 M:2 X:0` | `M4.3` |
| `2025-06-10` | **176** | 193.3 sfu | Kp 3.36 | 🟢 Nominal | `C:8 M:0 X:0` | `C2.3` |
| `2025-06-11` | **181** | 203.4 sfu | Kp 3.07 | 🟢 Nominal | `C:7 M:0 X:0` | `C5.2` |
