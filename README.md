...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`202`** | `[▰▰▰▰▰▰▰▰▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`219.3 sfu`** | `[▰▰▰▰▰▰▰▰▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`1.46`** | `[▰▰▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`C8.3 @ 17:58 UTC`** | `C:7  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| `2025-09-09` | **202** | 219.1 sfu | Kp 1.67 | 🟢 Quiet | `C:11 M:1 X:0` | `M3.2` |
