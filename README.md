...
[![Geomagnetic Status](https://img.shields.io/badge/Geomagnetic%20Activity-🔴%20G2%20Moderate-orange?style=for-the-badge&logo=speedtest&logoColor=white)](https://www.swpc.noaa.gov/products/planetary-k-index)
...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`167`** | `[▰▰▰▰▰▰▰▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`185.9 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`6.50`** | `[▰▰▰▰▰▰▰▱▱▱]` | **G2 (Moderate Storm)** — High-latitude power alarms; satellite drag |
| **24h Solar Flare Activity** | **`C6.1 @ 20:13 UTC`** | `C:8  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-11-17` | **147** | 170.6 sfu | Kp 2.35 | 🟢 Nominal | `C:6 M:1 X:0` | `M6.9` |
| `2025-11-18` | **157** | 170.2 sfu | Kp 2.86 | 🟢 Nominal | `C:5 M:0 X:0` | `C1.3` |
| `2025-11-19` | **146** | 174.9 sfu | Kp 1.75 | 🟢 Quiet | `C:6 M:0 X:0` | `C7.6` |
| `2025-11-20` | **169** | 189.1 sfu | Kp 2.06 | 🟢 Nominal | `C:10 M:1 X:0` | `M3.0` |
| `2025-11-21` | **167** | 183.6 sfu | Kp 2.73 | 🟢 Nominal | `C:6 M:2 X:0` | `M2.8` |
| `2025-11-22` | **172** | 194.6 sfu | Kp 3.57 | 🟢 Nominal | `C:8 M:0 X:0` | `C1.5` |
| `2025-11-23` | **167** | 185.9 sfu | Kp 6.50 | 🔴 G2 Moderate | `C:8 M:0 X:0` | `C6.1` |
