...
| **10.7 cm Solar Radio Flux** | **`183.4 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.56`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`M3.6 @ 04:23 UTC`** | `C:9  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
...
| `2026-03-16` | **158** | 189.7 sfu | Kp 2.54 | 🟢 Nominal | `C:6 M:0 X:0` | `C1.6` |
| `2026-03-17` | **148** | 173.3 sfu | Kp 2.57 | 🟢 Nominal | `C:7 M:1 X:0` | `M6.1` |
| `2026-03-18` | **153** | 175.3 sfu | Kp 5.76 | 🟠 G1 Minor | `C:8 M:0 X:0` | `C9.0` |
