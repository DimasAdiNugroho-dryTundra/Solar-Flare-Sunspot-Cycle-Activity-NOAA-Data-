...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`121`** | `[▰▰▰▰▰▱▱▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`136.2 sfu`** | `[▰▰▰▰▰▱▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.42`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C1.8 @ 07:58 UTC`** | `C:9  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| `2026-05-25` | **121** | 136.2 sfu | Kp 2.42 | 🟢 Nominal | `C:9 M:0 X:0` | `C1.8` |
