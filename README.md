...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`178`** | `[▰▰▰▰▰▰▰▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`190.8 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.73`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`M3.4 @ 23:43 UTC`** | `C:7  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
...
| `2025-08-16` | **200** | 217.3 sfu | Kp 1.91 | 🟢 Quiet | `C:10 M:1 X:0` | `M2.1` |
| `2025-08-17` | **203** | 222.1 sfu | Kp 1.28 | 🟢 Quiet | `C:10 M:0 X:0` | `C7.9` |
| `2025-08-18` | **198** | 215.4 sfu | Kp 2.50 | 🟢 Nominal | `C:10 M:1 X:0` | `M7.5` |
| `2025-08-19` | **172** | 182.5 sfu | Kp 2.24 | 🟢 Nominal | `C:8 M:1 X:0` | `M3.6` |
| `2025-08-20` | **178** | 190.8 sfu | Kp 2.73 | 🟢 Nominal | `C:7 M:1 X:0` | `M3.4` |
