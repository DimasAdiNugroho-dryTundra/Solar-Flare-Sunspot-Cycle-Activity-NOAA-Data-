...
| **10.7 cm Solar Radio Flux** | **`175.3 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`5.76`** | `[▰▰▰▰▰▰▱▱▱▱]` | **G1 (Minor Storm)** — Weak power grid fluctuations; aurora at ~60° |
| **24h Solar Flare Activity** | **`C9.0 @ 10:13 UTC`** | `C:8  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
