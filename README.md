...
| **10.7 cm Solar Radio Flux** | **`173.8 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`0.82`** | `[▰▱▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`C3.7 @ 19:55 UTC`** | `C:6  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
