...
| **10.7 cm Solar Radio Flux** | **`177.4 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`0.87`** | `[▰▱▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`M5.2 @ 05:32 UTC`** | `C:8  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
