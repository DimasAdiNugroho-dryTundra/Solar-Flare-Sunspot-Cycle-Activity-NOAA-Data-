...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`186`** | `[▰▰▰▰▰▰▰▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`210.1 sfu`** | `[▰▰▰▰▰▰▰▰▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.90`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`M2.9 @ 06:19 UTC`** | `C:10  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2026-04-29` | **131** | 153.9 sfu | Kp 2.43 | 🟢 Nominal | `C:5 M:0 X:0` | `C7.4` |
| `2026-04-30` | **158** | 173.4 sfu | Kp 0.84 | 🟢 Quiet | `C:5 M:1 X:0` | `M3.5` |
