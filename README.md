...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`194`** | `[▰▰▰▰▰▰▰▰▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`208.5 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.73`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C1.3 @ 02:16 UTC`** | `C:6  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| `2025-12-29` | **196** | 213.8 sfu | Kp 1.52 | 🟢 Quiet | `C:10 M:2 X:0` | `M1.0` |
| `2025-12-30` | **194** | 208.5 sfu | Kp 2.73 | 🟢 Nominal | `C:6 M:0 X:0` | `C1.3` |
