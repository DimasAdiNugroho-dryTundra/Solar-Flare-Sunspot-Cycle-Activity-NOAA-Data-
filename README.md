...
| **10.7 cm Solar Radio Flux** | **`161.6 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.96`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C8.0 @ 16:31 UTC`** | `C:6  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2025-05-30` | **184** | 199.7 sfu | Kp 2.11 | 🟢 Nominal | `C:9 M:1 X:0` | `M5.3` |
| `2025-05-31` | **163** | 182.4 sfu | Kp 1.17 | 🟢 Quiet | `C:8 M:1 X:0` | `M3.2` |
| `2025-06-01` | **157** | 167.7 sfu | Kp 2.88 | 🟢 Nominal | `C:9 M:0 X:0` | `C4.8` |
