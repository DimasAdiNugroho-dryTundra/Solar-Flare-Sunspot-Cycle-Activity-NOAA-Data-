...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`89`** | `[▰▰▰▰▱▱▱▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`117.8 sfu`** | `[▰▰▰▰▱▱▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`6.49`** | `[▰▰▰▰▰▰▰▱▱▱]` | **G2 (Moderate Storm)** — High-latitude power alarms; satellite drag |
| **24h Solar Flare Activity** | **`C8.5 @ 15:21 UTC`** | `C:6  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2026-07-13` | **126** | 146.3 sfu | Kp 2.57 | 🟢 Nominal | `C:9 M:0 X:0` | `C1.3` |
| `2026-07-14` | **99** | 135.4 sfu | Kp 5.10 | 🟠 G1 Minor | `C:7 M:0 X:0` | `C2.3` |
| `2026-07-15` | **99** | 125.3 sfu | Kp 2.86 | 🟢 Nominal | `C:6 M:0 X:0` | `C6.0` |
| `2026-07-16` | **101** | 133.9 sfu | Kp 2.57 | 🟢 Nominal | `C:6 M:0 X:0` | `C4.0` |
| `2026-07-17` | **84** | 111.8 sfu | Kp 1.33 | 🟢 Quiet | `C:8 M:0 X:0` | `C8.4` |
| `2026-07-18` | **96** | 129.8 sfu | Kp 5.13 | 🟠 G1 Minor | `C:6 M:0 X:0` | `C5.5` |
| `2026-07-19` | **89** | 117.8 sfu | Kp 6.49 | 🔴 G2 Moderate | `C:6 M:0 X:0` | `C8.5` |
