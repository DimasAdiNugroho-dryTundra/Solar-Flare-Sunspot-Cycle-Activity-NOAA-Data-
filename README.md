...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`124`** | `[▰▰▰▰▰▱▱▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`146.6 sfu`** | `[▰▰▰▰▰▱▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`2.81`** | `[▰▰▰▱▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C1.7 @ 13:35 UTC`** | `C:9  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
...
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `2026-04-20` | **167** | 190.0 sfu | Kp 2.59 | 🟢 Nominal | `C:6 M:2 X:0` | `M7.3` |
| `2026-04-21` | **157** | 180.5 sfu | Kp 1.48 | 🟢 Quiet | `C:9 M:1 X:0` | `M5.3` |
