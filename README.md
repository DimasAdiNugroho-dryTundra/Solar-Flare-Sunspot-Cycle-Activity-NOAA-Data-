...
| **10.7 cm Solar Radio Flux** | **`188.2 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`0.96`** | `[▰▱▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`C3.0 @ 16:25 UTC`** | `C:9  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
