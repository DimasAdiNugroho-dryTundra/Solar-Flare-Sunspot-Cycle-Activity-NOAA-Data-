...
| **10.7 cm Solar Radio Flux** | **`215.7 sfu`** | `[▰▰▰▰▰▰▰▰▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`3.99`** | `[▰▰▰▰▱▱▱▱▱▱]` | **G0 (Unsettled)** — Low geomagnetic fluctuations |
| **24h Solar Flare Activity** | **`C8.2 @ 11:30 UTC`** | `C:6  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
