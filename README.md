...
| **10.7 cm Solar Radio Flux** | **`189.2 sfu`** | `[▰▰▰▰▰▰▰▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`0.83`** | `[▰▱▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`C2.8 @ 11:13 UTC`** | `C:8  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
