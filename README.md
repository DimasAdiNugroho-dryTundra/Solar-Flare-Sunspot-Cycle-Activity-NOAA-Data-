...
| **10.7 cm Solar Radio Flux** | **`169.1 sfu`** | `[▰▰▰▰▰▰▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`1.69`** | `[▰▰▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`M7.6 @ 18:37 UTC`** | `C:6  M:1  X:0` | **🟡 MODERATE / ELEVATED** |
