...
| **10.7 cm Solar Radio Flux** | **`213.8 sfu`** | `[▰▰▰▰▰▰▰▰▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`1.52`** | `[▰▰▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`M1.0 @ 14:18 UTC`** | `C:10  M:2  X:0` | **🟡 MODERATE / ELEVATED** |
