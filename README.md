...
| :--- | :---: | :---: | :--- |
| **Daily Sunspot Number (SSN)** | **`96`** | `[▰▰▰▰▱▱▱▱▱▱]` | Active solar disk complex; multiple bipoles |
| **10.7 cm Solar Radio Flux** | **`129.8 sfu`** | `[▰▰▰▰▰▱▱▱▱▱]` | Ionospheric F2-layer ionization baseline |
| **Planetary Kp-Index (3h Max)** | **`5.13`** | `[▰▰▰▰▰▰▱▱▱▱]` | **G1 (Minor Storm)** — Weak power grid fluctuations; aurora at ~60° |
| **24h Solar Flare Activity** | **`C5.5 @ 02:29 UTC`** | `C:6  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
