...
| **Planetary Kp-Index (3h Max)** | **`1.95`** | `[▰▰▱▱▱▱▱▱▱▱]` | **G0 (Quiet)** — Minimal magnetospheric disturbance |
| **24h Solar Flare Activity** | **`C6.0 @ 11:44 UTC`** | `C:8  M:0  X:0` | **🟢 NORMAL / PRODUCTIVE** |
